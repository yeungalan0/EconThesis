...
In order to correct for selection bias we use the two stage selection model outlined in \sectlabel{methods:tssmodel}, and after comparing our results to the OLS model outlined in \eqref{eq:0}, the overall results are the same.\footnote{TODO: See Appendix X for the regular OLS results.} 
