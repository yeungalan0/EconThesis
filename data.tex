...
The first type is classroom data, which consists of individual student level characteristics as well as classroom characteristics. 
...
The second type of data we use is points data, which consists of the number of points students bid on classes and their preferences for certain classes. 
...
It is a number that represents the culmination of a student's high school GPA, their test scores, the difficulty of their high school curriculum, the quality of their high school, and their writing ability. 
...
If a student does not make it into any class on their preference list, then a class is chosen for the student at random. 
...
\hline
            N                        & \multicolumn{2}{c|}{226} & \multicolumn{2}{|c|}{292} & \multicolumn{2}{|c|}{290} & \multicolumn{2}{|c|}{285} & \multicolumn{2}{|c|}{319} & \multicolumn{2}{|c}{1,412} \\
\hline
\hline
\end{tabular}
\end{sidewaystable}
