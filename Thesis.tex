...
\usepackage{fancyhdr}
%Remove headers on pages with only floats
...
Due to data limitations we are unable to uncover how classmate ability impacts the grades of high or low achievers, which makes it challenging to prescribe any practical policy recommendations for the institution.
